...
&& ($_FILES["file"]["size"] < 1048576)   // 小于 1k kb
&& in_array($extension, $allowedExts))
{
	...
	else
	{
		...
		else
		{
			...
			$ran = rand(0,10000);
            move_uploaded_file($_FILES["file"]["tmp_name"], "upload/" . $_POST["phone"] .$ran. "." . $extension);

            $sql="UPDATE ego_users SET avatar = 'http://www.forvera.me/upload/".$_POST["phone"].$ran.".".$extension."' WHERE phone = ('$_POST[phone]')";
